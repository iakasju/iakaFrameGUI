...
## Cartouche locale — `iakaFrameGUI`

- Branche vérifiée : `fix/convergence-registre-exclu`
- Commits couverts : `8c50fd9`, `61addb8`, `05df974`, `f33cf6a`
- HEAD au moment du gate : `f33cf6a`
- Ce dépôt est l'autre application sœur, registre à 29 entrées.
