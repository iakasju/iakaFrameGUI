...
principleIds: [qualite, gestion-backlog, documentation, commits-versionnement, isolation-docker, self-hosted-first, reutilisation-existant, mvp-first, identite-badges, perimetres-etanches, langue, mock-en-dev, cadrage-avant-code, confirmation-actes-destructifs]
